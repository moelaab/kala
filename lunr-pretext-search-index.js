...
},
{
  ...
  "type": "Section",
  "number": "1.1",
  "title": "Pendahuluan untuk Nilai Eigen dan Vektor Eigen",
  "body": " Pendahuluan untuk Nilai Eigen dan Vektor Eigen   Bagian ini memperkenalkan konsep nilai eigen dan vektor eigen serta memberikan contoh sehingga kita dapat belajar lebih banyak tentang apa itu nilai eigen dan vektor eigen. Kemudian kita dapat menggunakan konsep tersebut dalam kehidupan kita untuk menyelesaikan masalah tertentu.    Sebelum kita memperkenalkan definisi vektor eigen dan nilai eigen, ada beberapa hal yang perlu diperhatikan berikut ini:    Misalkan adalah vektor yang ditunjukkan pada gambar. Gambarkan vektor dan vektor .     Jelaskan efek geometris dari perkalian skalar pada vektor . Kemudian sketsakan semua vektor berbentuk di mana adalah skalar.  Jelaskan efek geometris dari transformasi matriks yang didefinisikan oleh .  Misalkan adalah matriks dan dan adalah vektor sedemikian rupa sehingga . Gunakan linearitas perkalian matriks untuk menyatakan vektor-vektor berikut dalam bentuk dan .   .   .   .   .   .   .        Vektor-vektor tersebut ditunjukkan seperti berikut.     Perkalian skalar memiliki efek meregangkan dan mungkin membalik sepanjang garis yang didefinisikan oleh .  Transformasi matriks ini meregangkan vektor dengan faktor dalam arah horizontal dan membalik vektor secara vertikal.  Dengan menerapkan linearitas, kita melihat bahwa   .   .   .   .   .   .         Beberapa Contoh  Kita akan sekarang memperkenalkan definisi nilai eigen dan vektor eigen dan kemudian melihat beberapa contoh sederhana.    nilai eigen  vektor eigen  Diberikan matriks persegi , , kita katakan bahwa vektor tak-nol adalah vektor eigen dari jika ada skalar sedemikian rupa sehingga . Skalar disebut nilai eigen yang terkait dengan vektor eigen .    Pada pandangan pertama, ada banyak hal yang terjadi dalam definisi ini, jadi mari kita lihat sebuah contoh.    Perhatikan matriks dan vektor . Kita mendapatkan . Dengan kata lain, , yang mengatakan bahwa adalah vektor eigen dari matriks dengan nilai eigen terkait .  Demikian pula, jika , kita mendapatkan . Di sini juga, kita memiliki yang menunjukkan bahwa adalah vektor eigen dari dengan nilai eigen terkait .     "
},
{
  "id": "section4-1-2-2",
  "level": "2",
  ...
  "number": "7",
  "title": "",
  "body": "  Sebelum kita memperkenalkan definisi vektor eigen dan nilai eigen, ada beberapa hal yang perlu diperhatikan berikut ini:    Misalkan adalah vektor yang ditunjukkan pada gambar. Gambarkan vektor dan vektor .     Jelaskan efek geometris dari perkalian skalar pada vektor . Kemudian sketsakan semua vektor berbentuk di mana adalah skalar.  Jelaskan efek geometris dari transformasi matriks yang didefinisikan oleh .  Misalkan adalah matriks dan dan adalah vektor sedemikian rupa sehingga . Gunakan linearitas perkalian matriks untuk menyatakan vektor-vektor berikut dalam bentuk dan .   .   .   .   .   .   .        Vektor-vektor tersebut ditunjukkan seperti berikut.     Perkalian skalar memiliki efek meregangkan dan mungkin membalik sepanjang garis yang didefinisikan oleh .  Transformasi matriks ini meregangkan vektor dengan faktor dalam arah horizontal dan membalik vektor secara vertikal.  Dengan menerapkan linearitas, kita melihat bahwa   .   .   .   .   .   .      "
},
{
  "id": "section4-1-3-3",
  "level": "2",
  ...
  "number": "1.1.1",
  "title": "",
  "body": "  nilai eigen  vektor eigen  Diberikan matriks persegi , , kita katakan bahwa vektor tak-nol adalah vektor eigen dari jika ada skalar sedemikian rupa sehingga . Skalar disebut nilai eigen yang terkait dengan vektor eigen .   "
},
{
  "id": "section4-1-3-5",
  "level": "2",
  ...
  "number": "1.1.2",
  "title": "",
  "body": "  Perhatikan matriks dan vektor . Kita mendapatkan . Dengan kata lain, , yang mengatakan bahwa adalah vektor eigen dari matriks dengan nilai eigen terkait .  Demikian pula, jika , kita mendapatkan . Di sini juga, kita memiliki yang menunjukkan bahwa adalah vektor eigen dari dengan nilai eigen terkait .   "
},
{
  "id": "section4-2",
  "level": "1",
